#This script is used to encrypt a partial bitstream
#The encrypted partial bitstream would be then sent to the module 
#to reconfigure the reconfigurable partition
...
# === CONFIGURATION ===
input_path  = Path("../partial_bitstream/partial_flashing.bin")                  
output_path = Path("../partial_bitstream/partial_flashing_encrypted.bin")
